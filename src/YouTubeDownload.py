...
class YouTubeDownloadList(Screen):
	...
	if screenWidth and screenWidth == 1920:
		skin = """<screen position="center,center" size="945,555">
				...
				<widget source="key_red" render="Label" position="center,484" zPosition="2" size="210,60" valign="center" halign="center" font="Regular;33" backgroundColor="red" foregroundColor="white" />
				</screen>"""
	else:
		skin = """<screen position="center,center" size="630,370">
				...
				<widget source="key_red" render="Label" position="center,323" zPosition="2" size="140,40" valign="center" halign="center" font="Regular;22" backgroundColor="red" foregroundColor="white" />
				</screen>"""
